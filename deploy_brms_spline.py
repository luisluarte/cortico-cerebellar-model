...
sftp.put("src/simulations/run_brms_spline.R", "cortico-cerebellar-model/src/simulations/run_brms_spline.R")
print("Uploaded. Starting execution...")

cmd = "cd cortico-cerebellar-model && Rscript src/simulations/run_brms_spline.R"
