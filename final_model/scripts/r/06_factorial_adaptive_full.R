...
cat("Starting 06_factorial_adaptive_full.R (4 chains, 2000 iters, Adaptive MCMC)...\n")
...
sourceCpp("bio_mcmc_chain_adaptive_full.cpp")
...
run_baseline_chain_adaptive <- function(eval_fn, N_params, s_idx, target_mode, iters=2000) {
...
all_results <- list()
if(file.exists("../../results/factorial_final_adaptive_checkpoint.rds")) {
    all_results <- readRDS("../../results/factorial_final_adaptive_checkpoint.rds")
...
for(m in models) {
  ...
  saveRDS(all_results, "../../results/factorial_final_adaptive_checkpoint.rds")
}

saveRDS(all_results, "../../results/factorial_final_adaptive_A.rds")
cat("Finished! Saved factorial_final_adaptive_A.rds\n")
