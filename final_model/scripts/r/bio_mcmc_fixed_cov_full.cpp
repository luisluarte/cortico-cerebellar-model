...
// [[Rcpp::export]]
List run_bio_mcmc_fixed_cov_full(int iters, NumericMatrix X_r, NumericVector ITI_r, NumericVector reward_r,
  ...
  mat noise_mat = as<mat>(noise_mat_r);
