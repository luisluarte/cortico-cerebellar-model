...
init_joint <- function() {
  list(
    ...
    log_lambda_W_c = rep(-3, 32), z_W_c = rep(0, 32), sigma_W_c = rep(0.1, 32), W_c_raw = matrix(0, nrow=32, ncol=5),
    intercept_rt_pop = 0, sigma_intercept_rt = 0.1, intercept_rt_raw = rep(0, 5),
    log_lambda_W_rt = rep(-3, 32), z_W_rt = rep(0, 32), sigma_W_rt = rep(0.01, 32), W_rt_raw = matrix(0, nrow=32, ncol=5),
...
# Save the fit
fit_joint$save_object("joint_bnn_fit.rds")
