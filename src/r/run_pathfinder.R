...
cat("Compiling Full Hierarchical Bio Stan Model with DENSE BPTT...\n")
...
cat("Running Pathfinder for N=10...\n")
t0 <- Sys.time()
pf <- mod_full$pathfinder(
  data = data_stan,
  init = init_fun,
  num_paths = 4,
...
cat("\nSuccessfully found typical set using Pathfinder!\n")
