...
cat("Starting 03_nsga2_gamma_static.R...\n")
...
fitness_fn <- function(params_with_gamma) {
  ...
  # Map parameters to bounded space
...
cat("Running NSGA-II...\n")
# Reduced popsize/generations for fast replication to prove it works
...
# Select the point with the most balanced gamma (closest to 0.5)
...
saveRDS(mu_EB, "../../results/mu_EB_static.rds")
cat("Saved mu_EB_static.rds!\n")
