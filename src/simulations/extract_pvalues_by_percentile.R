...
pcts <- c(0.10, 0.25, 0.50, 0.75, 0.90, 0.95, 0.99)
res_list <- list()
...
cat("\n============================================\n")
cat("P-VALUES AT THE PEAK (T=2, T=3, T=4) BY PERCENTILE\n")
cat("============================================\n")
print(res_df)

write.csv(res_df, "results/pvalues_by_percentile.csv", row.names=FALSE)
cat("Saved to results/pvalues_by_percentile.csv\n")
