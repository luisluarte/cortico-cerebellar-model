...
cat("--- SD Comparison ---\n")
cat(sprintf("SD P1 Opt                : %.3f\n", sd(p1_opt)))
cat(sprintf("SD P1 Les (Intact GLM)   : %.3f\n", sd(p1_les_intact_glm)))
cat(sprintf("SD P1 Les (Refit GLM)    : %.3f\n", sd(p1_les_new_glm)))

cat("--- Mean Comparison ---\n")
cat(sprintf("Mean P1 Opt              : %.3f\n", mean(p1_opt)))
cat(sprintf("Mean P1 Les (Intact GLM) : %.3f\n", mean(p1_les_intact_glm)))
cat(sprintf("Mean P1 Les (Refit GLM)  : %.3f\n", mean(p1_les_new_glm)))
