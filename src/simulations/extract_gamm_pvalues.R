...
target_db_high <- mean(df_long$Delta_Beta)
...
cat("\n============================================\n")
cat("TRIAL-BY-TRIAL MARGINAL CONTRASTS (75th Percentile)\n")
cat("============================================\n")
print(res)

write.csv(res, "results/gamm_trial_pvalues.csv", row.names=FALSE)
cat("Saved to results/gamm_trial_pvalues.csv\n")
